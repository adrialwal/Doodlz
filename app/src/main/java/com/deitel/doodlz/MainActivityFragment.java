    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.background_color:
                ColorDialogFragment backgroundDialogFragment = new ColorDialogFragment();
                backgroundDialogFragment.setBackground(ColorDialogFragment.SET_BACKGROUND);
                backgroundDialogFragment.show(getFragmentManager(), "background color dialog");
                return true; // consume the menu event
            case R.id.upload_image:
                BackgroundImageFragment backgroundImageFragment = new BackgroundImageFragment();
                backgroundImageFragment.show(getFragmentManager(), "backgound image dialog");
                return true; // consume the menu event
