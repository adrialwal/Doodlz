...
public class ColorDialogFragment extends DialogFragment {
    ...
    public final static int SET_FOREGROUND = 0;
    public final static int SET_BACKGROUND = 1;
    ...
    private int color;
    private int background = SET_FOREGROUND;

    public void setBackground(final int backgroundColor) {
        background = backgroundColor == SET_BACKGROUND ? SET_BACKGROUND : SET_FOREGROUND;
    }
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        builder.setTitle(background == SET_BACKGROUND ?
                R.string.background_color_dialog : R.string.title_color_dialog);
